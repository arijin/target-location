...
总结：
velo -> ref(cam3) -> rect(cam3->cam2) -> image:
ref(cam3) --R--> rect(cam3)
rect(cam3) --b^2-->  rect(cam2)

x_rect(cam3):(x_cam3, y_cam3, z_cam3)
...
ref(cam3) --R--> rect(cam3)
Ex: y_iamge2-x = f^2_u * (x_cam3 - b^2_x) + c^2_u * z_cam3
                             ## x_cam2
    y_iamge2-y = f^2_v * (y_cam3 - b^2_y) + c^2_v * z_cam3
                             ## y_cam2
    y_iamge2-z = z_cam3
